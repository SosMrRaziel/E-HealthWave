"""EHealthWave: add certificate 

Revision ID: 95ab40336887
Revises: 
Create Date: 2024-09-10 16:33:49.771541
...
def upgrade():
    ...
    sa.Column('certificate_picture', sa.String(length=255), nullable=True),
    ...
    with op.batch_alter_table('certificates', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_certificates_certificate_picture'), ['certificate_picture'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('certificates', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_certificates_certificate_picture'))
